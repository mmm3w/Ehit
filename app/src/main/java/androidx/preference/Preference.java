    ...
    public void onBindViewHolder(@NonNull PreferenceViewHolder holder) {
        ...
        if (summaryView != null) {
            ...
            if (!TextUtils.isEmpty(summary)) {
                ...
                /* 满足个人需求做出的调整 */
                summaryView.setTextColor(ContextCompat.getColor(summaryView.getContext(), com.mitsuki.ehit.R.color.text_color_setting_summary));
            } else {
        ...
        if (titleView != null) {
            ...
            if (!TextUtils.isEmpty(title)) {
                ...
                /* 满足个人需求做出的调整 */
                titleView.setTextColor(ContextCompat.getColor(titleView.getContext(), com.mitsuki.ehit.R.color.text_color_setting_title));
            } else {
